# 2D Game Framework Library

Reusable C# library for a simple 2D game framework.
...
- `GameFramework.Configuration`
- `GameFramework.Items`
- `GameFramework.Logging`
- `GameFramework.Models`
- `GameFramework.Observers`
- `GameFramework.Strategies`
